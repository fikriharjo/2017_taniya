                ...
                <tbody>
                    ...
                    foreach ($result as $row) {
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a data-coa_id="<?= $row['id'] ?>" data-name="<?= $row['nama'] ?>" data-kode_akun="<?= $row['kode_akun'] ?>" data-header_akun="<?= $row['header_akun'] ?>" data-toggle="modal" data-target="#modal-edit" href="#" class="btn btn-warning btn-sm" title="edit"><i class="fa fa-edit"></i></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('master_data/edit_coa') ?>" method="POST">
                    ...
                    <div class="form-group">
                        <label>Header Akun</label>
                        <input type="number" name="header_akun" class="form-control" id="header_akun">
                    </div>
            </div>
            <div class="modal-footer">
