...
<section class="content">
    ...
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <a href="<?= base_url('transaksi/tambahRealisasi') ?>" class="btn btn-primary">
                ...
                <tbody>
                    ...
                    foreach ($result as $row) {
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="<?= site_url('transaksi/detail_realisasi/' . $row['kd_realisasi']) ?>" class="btn btn-info" title="detail"><i class="fa fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
