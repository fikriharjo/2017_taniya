        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <?php echo validation_errors() ?><br>
                    <form action="<?= base_url('transaksi/tambah_kekurangan_anggaran/'.$no_anggaran.'/'.$kurang) ?>" method="post">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" name="anggaran" class="form-control" value="<?= $nominal ?>" readonly>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Kurang</label>
                            <input type="number" name="tambah" class="form-control" value=<?php echo $kurang ?> readonly>
                        </div>
                        <?php $seharusnya = $kurang*-1; ?>
                        <div class="form-group col-md-12">
                            <label>Tambah</label>
                            <input type="number" name="tambah" class="form-control"  min=<?php echo $seharusnya ?> placeholder='-- Masukan nominal tambah -- ' required>
                        </div>
                        <div class="form-group col-md-12">
